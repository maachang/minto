...
このプロジェクトは [minto](https://github.com/maachang/minto)（llrtを使ったAWS Lambda軽量化フレームワーク）を使って構築されたWebアプリケーションで、mintoは aws lambdaの url function(サーバーレスWebアプリ)を構築します。
